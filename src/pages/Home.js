  ...
  render() {
    const findPlaceButton = !this.state.animateFindPlaceModal ? (
      ...
      <AnimateScale
        initialValue={1}
        finalValue={
          2 + styleConstants.windowWidth * styleConstants.windowHeight / 10000
        }
        shouldAnimateIn
        duration={500}
        style={{
    ...
    if (this.props.places) {
      if (this.state.activeTab === "Featured") {
        ...
        if (this.props.userPlaces) {
          ...
          places = places.filter(place => {
            ...
            return utilities.isValueInArray(place.id, this.props.userPlaces);
          });
      ...
      placesComponent = (
        <View style={styles.loaderContainer}>
          <ActivityIndicator size="large" color={styleConstants.primary} />
        </View>
      );
    }
    ...
    return (
      <Page style={styles.container}>
        <LinearGradient
          colors={[styleConstants.primary, styleConstants.darkPrimary]}
          ...
          />
          <Touchable onPress={() => Actions.search()} style={styles.searchBar}>
        ...
        {blankState}
        {placesComponent}
        <View style={styles.findPlaceButtonWrapper}>{findPlaceButton}</View>
        {findPlaceModal}
      </Page>
    );
  }
