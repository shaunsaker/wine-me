...
export default class ScrollHeader extends React.Component {
    ...
    static get propTypes() {
        return {
            ...
            finalHeaderBackgroundColor: PropTypes.string, // hex value TODO: handle rgb
    ...
    componentWillMount() {
        ...
        minHeaderHeight += Platform.OS === "ios" ? 21 : 0; // status bar height
    ...
    render() {
        ...
        const headerBackgroundColor = this.state.scrollY.interpolate({
            inputRange: [0, headerScrollDistance],
            outputRange: ["rgba(0, 0, 0, 0.167)", "rgba(0, 0, 0, 0)"],
            extrapolate: "clamp",
        });

        const headerTextComponent = this.props.headerTextComponent ? (
                ...
                <Animated.View
                    ...
                    <Animated.View
                        ...
                        <HeaderBar
                            ...
                            leftComponent={this.props.headerLeftComponent}
                            ...
                            rightComponent={this.props.headerRightComponent}
