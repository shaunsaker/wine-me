...
export default class FindPlaceModal extends React.Component {
    constructor(props) {
        ...
        this.handleLinkToLocation = this.handleLinkToLocation.bind(this);
    ...
    static get propTypes() {
        return {
            ...
            handleLinkToLocation: PropTypes.func,
        };
    }
    ...
    handleLinkToLocation() {
        ...
        this.props.handleLinkToLocation &&
            this.props.handleLinkToLocation(this.state.place.location);
    }
